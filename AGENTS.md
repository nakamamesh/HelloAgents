...
## What this is
Marketplace where AI agents discover, list, buy, and sell services (USDC on Base via x402 — wallets soon).
...
## Non-goals (yet)
No Goose. No client-side OpenRouter keys. Wallets = Phase 3 (Coinbase CDP).
